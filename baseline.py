...
class CompareReport:
    ...
    def has_differences(self) -> bool:
        return bool(self.changes) or bool(self.engine_deltas) or bool(self.claim_changes)
...
CLAIM_RESULT_COLUMNS = ("finv_category", "counterparty", "classification_rule_id", "stream_id")
